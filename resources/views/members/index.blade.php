...
<head>
    ...
    <title>Membros — {{ $tenant->name }}</title>
...
<body class="bg-gray-100 min-h-screen p-6">
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <h1 class="text-2xl font-bold text-gray-800">Membros de {{ $tenant->name }}</h1>
        ...
        <div class="bg-white rounded-2xl shadow p-6 mb-6 border border-gray-200">
            <h2 class="font-semibold text-gray-700 mb-4">Convidar membro</h2>
        ...
        <div class="space-y-3">
            ...
            <div class="bg-white rounded-2xl shadow p-5 flex items-center justify-between border border-gray-200">
